...
async def public_prostudio_pricing_catalog():
    ...
    rows = [
        ...
        ("BytePlus", "Видео", "Seedance 1.5 Pro", "480p / 720p / 1080p, 10 сек", "90 / 180 / 450 ⚡"),
        ("BytePlus", "Видео", "Seedance 1.0 Pro", "480p / 720p / 1080p, 5 сек", "45 / 90 / 225 ⚡"),
        ("BytePlus", "Текст", "Seed 1.6 / 1.6 Flash", "input / output, 1M токенов", "45 / 300 · 8 / 45 ⚡"),
        ("Google", "Текст", "Gemini 3.1 Flash", "input / output, 1M токенов", "113 / 563 ⚡"),
        ("Google", "Текст", "Gemini 2.5 Pro", "input / output, 1M токенов", "188 / 1 500 ⚡"),
        ("Google", "Текст", "Gemini 2.5 Flash Lite", "input / output, 1M токенов", "15 / 60 ⚡"),
        ("Google", "Фото", "Nano Banana 2 Flash", "0.5K / 1K / 2K / 4K", "3 / 6 / 9 / 15 ⚡"),
        ("Google", "Фото", "Imagen 3 / Imagen 4", "Fast / Standard / Ultra", "3 / 6 / 9 ⚡ / фото"),
        ("Google", "Видео", "Veo 3.1 Fast", "720p / 1080p, за секунду", "15 / 45 ⚡"),
        ("Google", "Видео", "Veo 2", "720p / 4K, за секунду", "15 / 30 ⚡"),
        ("Google", "Аудио", "Gemini TTS Flash / Pro", "1M символов", "15 / 30 ⚡"),
        ("Runway", "Видео", "WAN 3", "480p / 720p / 1080p, за секунду", "8 / 15 / 30 ⚡"),
        ("Runway", "Видео", "H3 / Aleph 2", "за секунду", "18 / 42 ⚡"),
        ("Runway", "Видео", "Act-Two", "за секунду", "8 ⚡"),
        ("Runway", "Фото", "Seedream 5 Pro / Lite", "1K / 2K / Lite", "8 / 14 / 6 ⚡"),
        ("Runway", "Фото", "Gemini Image 3 Pro", "1K/2K / 4K", "30 / 60 ⚡"),
        ("Runway", "Фото", "GPT Image 2", "Low / Medium / High, 1K", "2 / 8 / 30 ⚡"),
        ("Runway", "Инструмент", "Magnific Upscaler", "до 4096px / выше", "38 / 225 ⚡"),
        ("OpenAI", "Текст", "GPT-5.6 Terra / Luna", "input / output, 1M токенов", "300/1 800 · 30/180 ⚡"),
        ("OpenAI", "Текст", "GPT-5 / GPT-4.1", "input / output, 1M токенов", "188/1 500 · 300/1 200 ⚡"),
        ("OpenAI", "Текст", "GPT-4o / GPT-4o mini", "input / output, 1M токенов", "375/1 500 · 23/90 ⚡"),
        ("OpenAI", "Фото", "GPT Image 2", "Low / Medium / High, 1K", "2 / 8 / 30 ⚡"),
        ("OpenAI", "Аудио", "GPT-4o Transcribe / Whisper", "1 мин", "1 ⚡"),
        ("xAI", "Текст", "Grok 4.3 / 4.20", "input / output, 1M токенов", "188 / 375 ⚡"),
        ("xAI", "Фото", "Grok Imagine Image", "1K / 2K", "3 / 3 ⚡"),
        ("xAI", "Фото", "Grok Imagine Image Quality", "1K / 2K", "8 / 11 ⚡"),
        ("xAI", "Видео", "Grok Imagine Video", "480p / 720p, за секунду", "8 / 11 ⚡"),
        ("xAI", "Аудио", "Grok Voice Think Fast 2", "speech-to-speech, 1 мин", "12 ⚡"),
        ("Recraft", "Фото", "V4.1 Pro / Utility Pro", "raster, 1 фото", "32 ⚡"),
        ("Recraft", "Вектор", "V4.1 Pro / Utility Pro", "vector, 1 изображение", "45 ⚡"),
        ("Recraft", "Инструмент", "Remove Background / Vectorize / Upscale", "1 операция", "2 / 2 / 1 ⚡"),
        ("Recraft", "Инструмент", "Creative Upscale", "1 изображение", "38 ⚡"),
        ("FLUX", "Фото", "FLUX.2 Klein / Pro / Max / Flex", "text-to-image, от 1 MP", "3 / 5 / 11 / 8 ⚡"),
        ("FLUX", "Фото", "FLUX.1 Kontext / Pro / Ultra", "1 фото", "6 / 6 / 9 ⚡"),
        ("FLUX", "Видео", "FLUX 3", "Draft HD / HD / FHD, 5 сек", "45 / 128 / 218 ⚡"),
        ("ElevenLabs", "Голос", "Eleven v3 / Multilingual v2", "1 000 символов", "15 ⚡"),
        ("ElevenLabs", "Голос", "Flash / Turbo / Conversational", "1 000 символов", "8 ⚡"),
        ("ElevenLabs", "Музыка", "Eleven Music", "1 / 2 / 5 мин", "23 / 45 / 113 ⚡"),
        ("ElevenLabs", "Инструмент", "Sound Effects / Voice Changer / Isolator", "1 мин", "18 ⚡"),
        ("ElevenLabs", "Дубляж", "Dubbing v1 / v2", "1 мин", "50 / 75 / 330 ⚡"),
        ("Luma", "Фото", "UNI-1 / UNI-1 Max", "text-to-image, 2K", "7 / 15 ⚡"),
        ("Luma", "Видео", "Ray 3.2 Standard", "360p / 540p / 720p / 1080p, 5 сек", "9 / 23 / 45 / 180 ⚡"),
        ("Luma", "Видео", "Ray 3.2 Standard", "360p / 540p / 720p / 1080p, 10 сек", "27 / 68 / 135 / 540 ⚡"),
        ("Qwen", "Текст", "Qwen 3.8 Max / Flash", "input / output, 1M токенов", "300/900 · 23/71 ⚡"),
        ("Qwen", "Фото", "Qwen Image 3 Pro / Image 3", "1K / 2K", "6/12 · 5/5 ⚡"),
        ("Qwen", "Видео", "Wan 2.7", "720p / 1080p, 5 сек", "75 / 113 ⚡"),
        ("Qwen", "Видео", "HappyHorse 1.1", "480p / 720p / 1080p, 5 сек", "53 / 105 / 135 ⚡"),
        ("Kling", "Видео", "Kling 3.0 Turbo", "720p / 1080p, 5 сек", "84 / 105 ⚡"),
        ("Kling", "Видео", "Kling 3.0", "standard 720p / 1080p, 5 сек", "63 / 84 ⚡"),
        ("Kling", "Видео", "Kling 3.0 Omni", "video reference 720p / 1080p, 5 сек", "95 / 126 ⚡"),
        ("Kling", "Видео", "Kling 2.6", "standard 720p / 1080p, 5 сек", "32 / 53 ⚡"),
        ("Kling", "Инструмент", "Avatar / Lip Sync", "720p, 5 сек", "42 / 11 ⚡"),
        ("Ideogram", "Фото", "Ideogram 4 / 3", "Turbo / Default / Quality", "5 / 9 / 15 ⚡"),
        ("Ideogram", "Инструмент", "Background/Object remover / Upscale", "1 операция", "2 / от 5 / 9 ⚡"),
        ("PixVerse", "Видео", "PixVerse V6", "720p, без / со звуком, 5 сек", "68 / 90 ⚡"),
        ("HeyGen", "Видео", "Avatar V", "1 сек", "18 ⚡"),
        ("HeyGen", "Видео", "Avatar IV Photo / Custom", "5 сек", "29 / 61 ⚡"),
        ("MiniMax", "Видео", "H3 / H3 Max", "768p, 5 сек", "60 / 38 ⚡"),
