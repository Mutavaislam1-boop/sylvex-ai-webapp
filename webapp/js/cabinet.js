...
function renderGeneratedTelegramButton(url, kind) {
  ...
  function toggleCommunityMenu(force){const app=document.querySelector('.community-app');if(!app)return;const open=typeof force==='boolean'?force:!app.classList.contains('menu-open');app.classList.toggle('menu-open',open);document.body.classList.toggle('community-menu-visible',open)}
